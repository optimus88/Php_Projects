...
while ($row = mysql_fetch_array($matchDetailsList))
{
    ...
    ?>
<tr><td><a href="match_details_player_addition.php?id=<?php echo $match_id;?>&cndt=<?php echo $flag; ?> "><?php echo $teamName_1; ?> vs <?php echo $teamName_2; ?></a></td><td><?php echo $matchType; ?></td><td><?php echo $matchVenue; ?></td><td><?php echo $matchdate; ?></td><td><?php echo $flag_value; ?></td></tr>
