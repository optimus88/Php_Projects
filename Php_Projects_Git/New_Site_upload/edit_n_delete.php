...
$palyerID=$_GET["pid"];
//echo $matchID;
$transcSelectQuery = "SELECT tally_bidder_name,tally_transc_id,bidder_name,bidder_id,tally_amt,tally_rate,tally_team_name FROM tallyworld.tally_transaction_details,tallyworld.tally_bidders WHERE tally_transc_id=$transactionID AND bidder_id=tally_bidder_name";
