...
if(isset($_SESSION['admin']))
{
  ...
  $biddersDetails = "SELECT * FROM tallyworld.tally_transaction_details, tallyworld.tally_bidders WHERE tally_bidder_name=bidder_id AND tally_match_details_id_fk='$match_id' ";
